...
* Setup
Please, watch the screencasts provided below before coming to the Tuesday session. On Tuedays, you have the option to ask questions about the material in screencasts (and I might ask you a few questions to see whether things are clear). We might then do an exercise together in class. On Thursdays, we will discuss more exercises. In terms of /preparation/, you have to have watched the screencasts before the Tuesday session and read through the first 2 exercises. For the Thursday sessions, you should have spend a bit time on trying to solve the remaining exercises. (Don't be discouraged if you do not manage to solve them quickly. Some of them are a bit tricky.)  As an organizational remark: as we have only one projector, it is useful to bring a printout of the exercises with you to class. 
