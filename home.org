...
* News
- Following the poll, we will have our make up lecture on Wednesday June 2 at 14.00.   
  - June 3 is a holiday. However, it is not proper to skip both lecture and exercise session because one of them is a public holiday (in particular as two Thursdays are public holidays this semester). Therefore, I suggest that we have a make up session for this holiday. Please, vote for your favorite time for this [[https://dudle.inf.tu-dresden.de/matGo3vejg/][here]] and I will announce the slot on this website on May 25. 
...
- Exercises: [[./exercises.tex][tex]] [[https://github.com/schottmueller/advMicro/files/4439088/exercises.pdf][pdf]], [[https://web.tresorit.com/l#q1HQe8-nJBZSRORWTxSfbg][solutions]] for some exercises not covered in class
- Slides:
