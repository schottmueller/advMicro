...
# - resit date: October 7, 16:00-17:00 in SSC 4.210
 - exam date: July 19, 11:00-12:00 in 100/U1/HSVIIa 

* Time and place
 - Tuesday, 10:00-11:30, Seminarraum S37 (102/U1/-1.314)
 - Thursday, 14:00-15:30, Seminarraum S263 (118/03/3.06)

* Setup
Please, watch the screencasts provided below before coming to the Tuesday session. On Tuedays, you have the option to ask questions about the material in the screencasts (and I might ask you a few questions to see whether things are clear). We might then do an exercise together in class. On Thursdays, we will discuss more exercises. In terms of /preparation/, you have to watch the screencasts before the Tuesday session and read through the first 2 exercises on the respective topic. For the Thursday sessions, you should have spent a bit time on trying to solve the remaining exercises. (Don't be discouraged if you do not manage to solve them quickly. Some of them are a bit tricky.)  As an organizational remark: as we have only one projector, it is useful to bring a printout of the exercises with you to class. 
...
References for the papers and books in an old [[https://github.com/schottmueller/advMicro/files/2737411/home.pdf][pdf version]] of this site.
