...
* News
- The second exam is planned for September 29, 14:00. Registration via KLIPS should be possible soon.
- you can find the exam [[https://github.com/schottmueller/advMicro/files/6900290/exam21aEx.pdf][here]]  
- A link to the exam will be published here on July 29, 14:00. Solutions should be sent via email (either with a -- preferably not too large -- attachment or as a link to a public file in your Dropbox/Sciebo/Tresorit etc.) to [c dot schottmueller at uni minus koeln dot de]. Your email must be received by 15:30. Please, keep in mind that email delivery can sometimes take 2 or 3 minutes.
- The solutions sketches to exercises not covered in class now also contain notes on the screening exercise 3.
...
- I updated the lecture notes to explain why there is a unique symmetric equilibrium in the sealed bid first price auction.
- Due to a public holiday, there is no exercise session on May 13. We will meet again on May 20 and discuss the screencasts and exercise on subgame perfect Nash equilibrium as well as the remaining exercises from last time. 
- The exam is on Thursday, July 29 between 14:00 and 15:00. Please, register via KLIPS (if you are a PhD student, register by writing me an email).
- I added a formal proof of the continuity of the best response in exercise 1 (Nash theorem) to the  "[[https://web.tresorit.com/l#q1HQe8-nJBZSRORWTxSfbg][solutions]] for some exercises not covered in class".
...
- The meeting room for Thursdays is 931 9084 5774 (sorry for putting the wrong room number here first...) the PW is 997194. The Tuesday lecture is substituted by the  [[https://web.tresorit.com/l/5sWSJ#n7VsMyNRyBLszIHnUrQzXA][screencasts]].
...
Meetings are conducted via zoom using the room 931 9084 5774 the pw is 997194. Unless stated otherwise, meetings are on Thursday 14:00-15:30. Before the meeting you should have watched the screencasts on the topic of the week and tried to solve the exercises on this topic on your own. In the meeting, you have the opportunity to ask questions on the screencasts and we will also go through the exercises (quickly).
* Material
- [[https://web.tresorit.com/l/5sWSJ#n7VsMyNRyBLszIHnUrQzXA][link]] to screencasts for lecture material

- [[https://github.com/schottmueller/advMicro/files/3255945/exam.pdf][old exam]] 
- Exercises: [[./exercises.tex][tex]] [[https://github.com/schottmueller/advMicro/files/6849499/exercises.pdf][pdf]], [[https://web.tresorit.com/l#q1HQe8-nJBZSRORWTxSfbg][solutions]] for some exercises not covered in class
- Slides:
...
References for the papers in an old [[https://github.com/schottmueller/advMicro/files/2737411/home.pdf][pdf version]] of this site.
