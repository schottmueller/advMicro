...
* News
- On July 11, we use the class as question hour. If you want to have an answer for sure, please send me your questions before July 9. 
- Updtaed slides (lecture June 27): added an explanation at the end of the slides why ex ante budget balance is sufficient for ex post budget balance; changed almost efficient mechanism for many seller/buyer setting such that it is dominant strategy incentive compatible for finite $m$ and $n$
...
- Slides:
  ...
  - [[https://github.com/schottmueller/advMicro/files/2140704/CremerMcLean.pdf][correlated information]]
...
** Mechanism design VI: optimal mechanisms and limits
